...
const DEMO = {
  kda: {
    ...
    sections:[
      ...
      {id:"resources",title:"采集",emoji:"⛏️",color:"#26a69a",items:[{id:"metalOre",label:"金属矿石",value:189400,icon:"🪨"},{id:"stone",label:"石头",value:876200,icon:"🧱"},{id:"wood",label:"木头",value:1542300,icon:"🪵"},{id:"scrap",label:"废料",value:18340,icon:"🧲"},{id:"lowGradeFuel",label:"低级燃料",value:7520,icon:"🛢️"},{id:"cloth",label:"布",value:234500,icon:"🧶"},{id:"leather",label:"皮革",value:98320,icon:"🧥"},{id:"sulfurOre",label:"硫矿",value:84210,icon:"💛"},{id:"boneFragments",label:"骨片",value:6410,icon:"🦴"},{id:"animalFat",label:"动物脂肪",value:7850,icon:"🥩"}]},
